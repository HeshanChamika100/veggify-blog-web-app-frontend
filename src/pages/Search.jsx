...
const Search = () => {
  ...
  useEffect(() => {
    const fetchItems = async () => {
      setLoading(true);
      try {
        const response = await axios.get(`https://veggify-blog-web-app-backend.vercel.app/api/items`, {
          params: {
            q: query,
          },
        });
  ...
  return (
    <div className="px-6 lg:px-12 py-20">
      <h1 className="text-center text-3xl py-10 font-semibold text-secondary sm:text-6xl sm:leading-relaxedÍ">
        Search
      </h1>
