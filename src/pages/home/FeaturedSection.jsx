  ...
  return (
    <div className="overflow-hidden flex sm:flow-row md:flex-row flex-col justify-between items-center sm:my-20 my-4 md:gap-20 gap-12 px-5 lg:px-10">
      ...
      <div className="text-start sm:w-1/2">
        ...
        <p className="text-xl mt-4 text-[#5c5c5c]">Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel nobis laborum consectetur, voluptatem fugit provident, rem placeat maxime magnam debitis nesciunt veniam reiciendis, culpa quam. Iure perferendis ipsa deserunt hic.</p>
